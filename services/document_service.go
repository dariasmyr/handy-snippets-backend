...
type DocumentService interface {
	...
	CreateDocument(value string, accessKey string, maxViewCount, ttlMs int) (int, error)
	UpdateDocument(id int, value *string, accessKey string, maxViewCount, ttlMs int) (bool, error)
